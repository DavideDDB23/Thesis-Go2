...
def main():
    ...
    policy = torch.jit.load(f"/Users/davide/Tesi_2025/Genesis-main/examples/locomotion/backflip/{args.exp_name}.pt")
    policy.to(device="mps" if torch.backends.mps.is_available() else "cpu")
